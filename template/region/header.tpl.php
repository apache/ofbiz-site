...
<header id="mainHeader" class="clearfix">
  <div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container"> <a href="<?= $base_url ?>index.html" class="brand"><img src="<?= $base_url ?>images/ofbiz_logo.png" alt="Apache OFBiz Logo"/></a>
        <nav id="mainMenu" class="clearfix">
          <ul>
            <li><a href="<?= $base_url ?>index.html" class="firstLevel<?php if (basename($page_name) == 'index.tpl.php'):?> active<?php endif;?>">Home</a></li>
            <li><a href="#" class="firstLevel<?php if ($page_name == 'getting-started.tpl.php'):?> active<?php endif;?>">Getting Started</a>
              <ul>
                <li><a href="<?= $base_url ?>developers.html" class="">Developers</a></li>
                <li><a href="<?= $base_url ?>business-users.html" class="last">Business Users</a></li>
              </ul>
            </li>
            ...
            <li><a href="#" class="firstLevel<?php if (basename($page_name) == 'community.tpl.php'):?> active<?php endif;?>">Community</a>
              <ul>
                <li><a href="<?= $base_url ?>getting-involved.html">Getting Involved</a></li>
                <li><a href="<?= $base_url ?>mailing-lists.html">Mailing Lists</a></li>
                <li><a href="<?= $base_url ?>source-repositories.html">Source Repository</a></li>
                <li><a href="<?= $base_url ?>download.html">Downloads</a></li>
                <li><a href="https://s.apache.org/dsj2p" target="external" >Issue Tracker</a></li>
                <li><a href="<?= $base_url ?>faqs.html" class="last">FAQ</a></li>
              </ul>
            </li>
            <li><a href="<?= $base_url ?>ofbiz-demos.html" class="firstLevel<?php if (basename($page_name) == 'ofbiz-demos.tpl.php'):?> active<?php endif;?>">Demos</a></li>
            <li><a href="<?= $base_url ?>download.html" class="firstLevel<?php if (basename($page_name) == 'download.tpl.php'):?> active<?php endif;?>">Download</a></li>
          </ul>
        </nav>
      </div>
    </div>
