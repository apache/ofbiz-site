      ...
      <div class="container">
        <div class="row">
                ...
                <div class="tab-pane active" id="tabs-1">
                  <ul>
                    <li>
                      ...
                      <a href="https://www.apache.org/dyn/closer.lua/ofbiz/apache-ofbiz-17.12.06.zip" target="external" class="moreLink">&rarr; Download</a>
                    </li>
                  </ul>
                </div>
          ...
          <div class="span8">
            ...
            <h2>Apache OFBiz 17.12.06</h2>
            <div class="divider"><span></span></div>
            <p> Released on March 2021, this is the sixth and final release of the 17.12 series, that has been stabilized since December 2017.</p>
            <a href="https://www.apache.org/dyn/closer.lua/ofbiz/apache-ofbiz-17.12.06.zip" target="external" >Download OFBiz 17.12.06</a>
            <a href="https://downloads.apache.org/ofbiz/apache-ofbiz-17.12.06.zip.asc" target="external">[PGP]</a>
            <a href="https://downloads.apache.org/ofbiz/apache-ofbiz-17.12.06.zip.sha512" target="external">[SHA512]</a>
            <a href="https://downloads.apache.org/ofbiz/KEYS" target="external">[KEYS]</a>
            <a href="release-notes-17.12.06.html">[Release Notes]</a>
