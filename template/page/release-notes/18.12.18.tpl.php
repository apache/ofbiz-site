...
?>
 ...
 <section id="content" class="fullWidth">
    <header class="headerPage">
      ...
      <div class="span4" id="navTrail"> <a href="<?= $base_url ?>index.html" class="homeLink">home</a><span>/</span><a href="<?= $base_url ?>download.html">Download</a><span>/</span><span class="current">Release Notes 18.12.18</span> </div>
        </div>
      </div>
    </header>
...
<div class="row">
  <div>
  <p>Apache OFBiz&reg; 18.12.18, released in March 2025, is the 18th release of the 18.12 series, which has been feature-frozen since December 2018, receiving only bug fixes.</p>
