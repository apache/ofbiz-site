...
?>
 ...
 <section id="content" class="fullWidth">
    <header class="headerPage">
      ...
      <div class="span4" id="navTrail"> <a href="<?= $base_url ?>index.html" class="homeLink">home</a><span>/</span><a href="<?= $base_url ?>download.html">Download</a><span>/</span><span class="current">Release Notes 12.04.06</span> </div>
        </div>
      </div>
    </header>
