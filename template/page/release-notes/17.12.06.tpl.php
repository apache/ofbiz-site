...
?>
 ...
 <section id="content" class="fullWidth">
    <header class="headerPage">
      ...
      <div class="span4" id="navTrail"> <a href="<?= $base_url ?>index.html" class="homeLink">home</a><span>/</span><a href="<?= $base_url ?>download.html">Download</a><span>/</span><span class="current">Release Notes 17.12.06</span> </div>
        </div>
      </div>
    </header>
...
<div class="row">
  <div>
  <p>Apache OFBiz&reg; 17.12.06, released on March 2021, is the sixth and final release of the 17.12 series, that has been stabilized since December 2017.</p>
