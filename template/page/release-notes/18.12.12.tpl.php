...
?>
 ...
 <section id="content" class="fullWidth">
    <header class="headerPage">
      ...
      <div class="span4" id="navTrail"> <a href="<?= $base_url ?>index.html" class="homeLink">home</a><span>/</span><a href="<?= $base_url ?>download.html">Download</a><span>/</span><span class="current">Release Notes 18.12.12</span> </div>
        </div>
      </div>
    </header>
...
<div class="row">
  <div>
  <p>Apache OFBiz&reg; 18.12.12, released on February 2024, is the twelfth release of the 18.12 series, that has been stabilized since December 2018.</p>
