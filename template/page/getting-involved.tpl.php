<?php //Variable declarations for region templates
  $head_title = '<title>The Apache OFBiz&reg; Project - Getting Involved</title>';
?>
 ...
 <section id="content" class="fullWidth">
    <header class="headerPage">
      ...
      <div class="span4" id="navTrail"> <a href="<?= $base_url ?>index.html" class="homeLink">home</a><span>/</span><a href="#">Community</a><span>/</span><span class="current">Getting Involved</span> </div>
        </div>
      </div>
    </header>
  <section id="content" class="features" >
      ...
      <div class="container">
        <div class="row ">
         ...
         <li> <a href="#GInvFindBugs"> Reporting Bugs </a> </li>
              <li> <a href="#GInvCode"> Contibuting Code and Bug Fixes </a> </li>
    ...
    <p>Our <a href="<?= $base_url ?>mailing-lists.html">mailing lists </a> are also a great place for you to introduce yourself and join our community.</p>
     ...
     <p>All submitted patches will be reviewed by our volunteers and if it meets the project standard, will be integrated into our codebase.</p>
      ...
      <section  id="GInvDocs" class="slice row clearfix">
              <div class="span10">
                ...
                <div class="divider"><span></span></div>
                <p>If you are ready to help us document code, provide tips and trick or anything else that is not coding, then we have a WIKI that allows community contributions. Simply let us know on the <strong>user@ofbiz.apache.org</strong> mailing list that you want to become a contributor.</p>
     <p><strong>PLEASE NOTE:</strong> You will need to complete an Individual Contributor Licence Agreement (ICLA).</p>
              </div>
            </section>
